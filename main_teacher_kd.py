...
def main():
    ...
    train_parser.add_argument("--model_title", type=str, default="teacher", help="model_title, default set to model_title")
    ...
    test_parser.add_argument("--model_title", type=str, default="teacher",help="model_title, default set to model_title")
...
def train(args):
    ...
    net = Teacher(n_colors=colors, n_feats=args.n_feats, n_lkb=args.n_blocks, scale=args.n_scale)
    # print(net)
...
def calculate_mpsnr(test_loader, model, args):
    ...
    model.train()
    return current_mpsnr  # 返回平均 MPSNR
